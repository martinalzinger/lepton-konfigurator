...
(function(){
 ...
 function renderAngebot(r){return docHead("Angebot-Nr.")+addrBlock()+'<div class="dtitle">ANGEBOT<span class="u"></span></div>'+salutation()+machineSpec("",true)+linesHTML(r.sel,"Ausgew\u00e4hlte Optionen",true)+totalsHTML(r,"Gesamtkaufpreis (netto) inkl. aller gew\u00e4hlten Ausstattungsvarianten")+termsHTML()+legalBlock(r.tax)+signSingle();}
