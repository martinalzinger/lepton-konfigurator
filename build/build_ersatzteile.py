...
.mvparts{flex:1;max-width:400px;min-width:260px;display:flex;flex-direction:column;border-left:1px solid var(--line);background:#fff}
...
@media (max-width:760px){.mvbox{height:96vh;max-height:96vh}.mvsplit{flex-direction:column}.mvstage{flex:none;height:55vh}.mvparts{max-width:none;border-left:0;border-top:1px solid var(--line)}}
/* Toast */
